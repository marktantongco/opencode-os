...
## Quality Gates
Assumptions stated + validated? Reasoning complete + counter-cases? Code: runs, errors, edge cases, type-safe, production or [CONCEPT]? Strategy: frame justified, evidence, alternatives, impact, inverse? Analysis: data path, alternatives, limitations, confidence?
