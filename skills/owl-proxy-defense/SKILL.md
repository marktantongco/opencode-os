---
name: owl-proxy-defense
description: >
  Protocol-first proxy defense stack with 5-tier escalation — http/1.1 core, ja3/ws browser on demand — anti-bot resilience with per-provider routing and CI/CD enforcement. Use when use when building proxy defense layers, anti-bot systems, or protocol escalation strategies for web scraping and api access
  Triggers on keywords: proxy, defense, anti-bot, protocol, escalation, owl.
...
Protocol-first proxy defense stack with 5-tier escalation — rate limiting, IP rotation, header stripping, TLS fingerprinting, and circuit breaker patterns. This skill provides infrastructure-as-code patterns and operational procedures that ensure reliability, security, and observability of critical infrastructure components.
...
**Input:** "Use when building proxy defense layers, anti-bot systems, or protocol escalation strategies for web scraping and API access"
...
### Architecture
Multi-layer owl proxy defense with automatic failover between primary and backup endpoints.
