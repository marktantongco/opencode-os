...
name: agent-roles
description: >
  Unified multi-agent role system — Builder, Coder, Council, Orchestrator, Plan, Researcher, Reviewer, Scribe. Use when use when coordinating multi-agent workflows with role delegation
  Triggers on keywords: agents, roles, orchestration, delegation.
