...
name: mcp-registry
description: >
  Searchable directory of 105+ free MCP servers across 14 categories with deduplication and compatibility scoring. Use when use when searching for mcp servers or checking compatibility scores
  Triggers on keywords: mcp, registry, directory, servers, catalog.
...
Searchable directory of 105+ free MCP servers across 14 categories. Find, evaluate, and install MCP servers for any development need — from database access to API integration. This skill operates within the MCP (Model Context Protocol) ecosystem, providing tools for server discovery, configuration, security, and orchestration.
...
**Input:** "Use when searching for MCP servers or checking compatibility scores"
